...
JAVAOUT="$BASE/src/main/java/org/mira/llvm/binding"
...
mkdir -p "$JAVAOUT"
mkdir -p "$COUT"
swig -includeall -I"$BASE/src/main/swig/include" -outdir "$JAVAOUT" -o "$COUT"/LLVM_wrap.c -java -package org.mira.llvm.binding -fakeversion 2.0.4 "$BASE/src/main/swig/LLVM.i"
