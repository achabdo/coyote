...
public abstract class CompilerPlugin extends Plugin {
     ...
     *            bitcode.
     */
    public abstract void beforeClass(Config config, Clazz clazz)
            throws IOException;
     ...
     *            bitcode.
     */
    public abstract void beforeMethod(Config config, Clazz clazz, SootMethod method) throws IOException;
     ...
     *            bitcode.
     */
    public abstract void afterClass(Config config, Clazz clazz)
            throws IOException;
     ...
     */
    public abstract void afterMethod(Config config, Clazz clazz, SootMethod method) throws IOException;
