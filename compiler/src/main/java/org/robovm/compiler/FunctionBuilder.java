...
public class FunctionBuilder {
    ...
    public static Function lookup(SootMethod method) {
        return new FunctionBuilder(lookupWrapperSymbol(method), 
                getFunctionType(method)).linkage(external).build();
    }

    public static Function lookup(ClazzInfo ci, MethodInfo mi) {
    ...
    public static Function method(SootMethod method) {
        return new FunctionBuilder(methodSymbol(method), getFunctionType(method)).linkage(Linkage.weak)
